...
function openLearnerSignup(action) {
  ...
  document.getElementById('learner-modal-body').innerHTML =
    ...
    + '<div class="grid-2"><div class="form-group"><label>Transmission</label><select id="lr-trans" required><option>Manual</option><option>Automatic</option></select></div>'
    + '<div class="form-group"><label>Gender pref.</label><select id="lr-gend" required><option value="no_preference">No preference</option><option value="male">Male</option><option value="female">Female</option></select></div></div>'
